...
function ecommerce_gem_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'      => esc_html__( 'WooCommerce', 'ecommerce-gem-plus' ),
			'slug'      => 'woocommerce',
			'required'  => false,
		),
		array(
			'name'     => esc_html__( 'One Click Demo Import', 'ecommerce-gem-plus' ),
			'slug'     => 'one-click-demo-import',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'MailChimp for WordPress', 'ecommerce-gem-plus' ),
			'slug'     => 'mailchimp-for-wp',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Contact Form 7', 'ecommerce-gem-plus' ),
			'slug'     => 'contact-form-7',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'YITH WooCommerce Wishlist', 'ecommerce-gem-plus' ),
			'slug'     => 'yith-woocommerce-wishlist',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Video Tab For WooCommerce', 'ecommerce-gem-plus' ),
...
//=============================================================
function ecommerce_gem_theme_updater() {

	require get_template_directory() . '/includes/updater/theme-updater.php';

}

add_action( 'after_setup_theme', 'ecommerce_gem_theme_updater' );