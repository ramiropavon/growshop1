...
$wp_customize->add_section( 'section_layout',
	array(
		'title'      => esc_html__( 'Layout Options', 'ecommerce-gem-plus' ),
		'priority'   => 100,
...
$wp_customize->add_control( 'theme_options[enable_sticky_sidebar]',
	array(
		'label'    			=> esc_html__( 'Enable Sticky Sidebar', 'ecommerce-gem-plus' ),
...
$wp_customize->add_control( 'theme_options[global_layout]',
	array(
		'label'    => esc_html__( 'Global Layout', 'ecommerce-gem-plus' ),
		'section'  => 'section_layout',
		'type'     => 'radio',
		'priority' => 100,
		'choices'  => array(
...
$wp_customize->add_control( 'theme_options[excerpt_length]',
	array(
		'label'       => esc_html__( 'Excerpt Length', 'ecommerce-gem-plus' ),
		'description' => esc_html__( 'in words', 'ecommerce-gem-plus' ),
		'section'     => 'section_layout',
		'type'        => 'number',
		'priority'    => 100,
...
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
		'label'    => esc_html__( 'Read More Text', 'ecommerce-gem-plus' ),
		'section'  => 'section_layout',
		'type'     => 'text',
		'priority' => 100,
	)
