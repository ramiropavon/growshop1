...
$wp_customize->add_section( 'section_shop',
	array(
		'title'      => esc_html__( 'Shop Page Options', 'ecommerce-gem-plus' ),
		'priority'   => 100,
...
$wp_customize->add_control( 'theme_options[shop_layout]',
	array(
		'label'    => esc_html__( 'Shop Sidebar', 'ecommerce-gem-plus' ),
		'section'  => 'section_shop',
		'type'     => 'radio',
		'priority' => 100,
		'choices'  => array(
				'left-sidebar'  => esc_html__( 'Left Sidebar', 'ecommerce-gem-plus' ),
				'right-sidebar' => esc_html__( 'Right Sidebar', 'ecommerce-gem-plus' ),
				'no-sidebar'    => esc_html__( 'No Sidebar', 'ecommerce-gem-plus' ),
			),
	)
);
...
$wp_customize->add_control( 'theme_options[product_per_page]',
	array(
		'label'    		=> esc_html__( 'Products Per Page', 'ecommerce-gem-plus' ),
		'description'   => esc_html__( 'Total number of products shown per page', 'ecommerce-gem-plus' ),
		'section'  		=> 'section_shop',
		'type'     		=> 'number',
		'priority' 		=> 100,
...
$wp_customize->add_control( 'theme_options[product_number]',
	array(
		'label'    		=> esc_html__( 'Products Per Row', 'ecommerce-gem-plus' ),
		'description'   => esc_html__( 'Number of products shown per row', 'ecommerce-gem-plus' ),
		'section'  		=> 'section_shop',
		'type'     		=> 'select',
		'priority' 		=> 100,
		'choices'  		=> array(
							'2'  	=> esc_html__( '2', 'ecommerce-gem-plus' ),
							'3' 	=> esc_html__( '3', 'ecommerce-gem-plus' ),
							'4'    	=> esc_html__( '4', 'ecommerce-gem-plus' ),
						),
	)
);
...
$wp_customize->add_control( 'theme_options[hide_product_sorting]',
	array(
		'label'    			=> esc_html__( 'Disable Product Sorting Option', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_shop',
		'type'     			=> 'checkbox',
		'priority' 			=> 100,
	)
...
$wp_customize->add_control( 'theme_options[show_detail_icon]',
	array(
		'label'    			=> esc_html__( 'Enable View Detail Icon at Product Pages', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_shop',
		'type'     			=> 'checkbox',
		'priority' 			=> 100,
	)
...
$wp_customize->add_control( 'theme_options[enable_gallery_zoom]',
	array(
		'label'    			=> esc_html__( 'Enable Image Zoom at Product Detail Page', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_shop',
		'type'     			=> 'checkbox',
		'priority' 			=> 100,
	)
...
$wp_customize->add_control( 'theme_options[disable_related_products]',
	array(
		'label'    			=> esc_html__( 'Disable Related Products at Product Detail Page', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_shop',
		'type'     			=> 'checkbox',
		'priority' 			=> 100,
	)
