...
$wp_customize->add_section( 'section_breadcrumb',
	array(
		'title'      => esc_html__( 'Breadcrumb Options', 'ecommerce-gem-plus' ),
		'priority'   => 100,
...
$wp_customize->add_control( 'theme_options[breadcrumb_type]',
	array(
		'label'       => esc_html__( 'Breadcrumb Type', 'ecommerce-gem-plus' ),
		'section'     => 'section_breadcrumb',
		'type'        => 'radio',
		'priority'    => 100,
		'choices'     => array(
			'disable' => esc_html__( 'Disable', 'ecommerce-gem-plus' ),
			'simple'  => esc_html__( 'Simple', 'ecommerce-gem-plus' ),
		),
	)
);
...
$wp_customize->add_control( 'theme_options[breadcrumb_text]',
	array(
		'label'    			=> esc_html__( 'Breadcrumb Home Text', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_breadcrumb',
		'type'     			=> 'text',
		'priority' 			=> 100,
