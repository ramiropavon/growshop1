...
$wp_customize->add_control('theme_options[site_identity]', 
	array(
		'type' 		=> 'radio',
		'label' 	=> esc_html__('Logo Options', 'ecommerce-gem-plus'),
		'section' 	=> 'title_tagline',
		'choices' 	=> array(
			'logo-only' 	=> esc_html__('Logo Only', 'ecommerce-gem-plus'),
			'title-text' 	=> esc_html__('Title + Tagline', 'ecommerce-gem-plus'),
			'logo-desc' 	=> esc_html__('Logo + Tagline', 'ecommerce-gem-plus')
			)
	)
);
...
$wp_customize->add_section( 'section_header',
	array(
		'title'      => esc_html__( 'Top Header Options', 'ecommerce-gem-plus' ),
		'priority'   => 100,
...
$wp_customize->add_control( 'theme_options[enable_sticky]',
        array(
                'label'           => esc_html__( 'Make Main Nav Sticky', 'ecommerce-gem-plus' ),
...
$wp_customize->add_control( 'theme_options[show_top_header]',
	array(
		'label'    			=> esc_html__( 'Show Top Header', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'checkbox',
		'priority' 			=> 100,
	)
...
$wp_customize->add_control( 
	new eCommerce_Gem_Info( 
		...
		array(
			'label' 			=> esc_html__( 'Left Section', 'ecommerce-gem-plus' ),
			'section' 			=> 'section_header',
			'priority' 			=> 100,
...
$wp_customize->add_control( 'theme_options[top_left_type]',
	array(
		'label'           => esc_html__( 'Left Section Options', 'ecommerce-gem-plus' ),
		'section'         => 'section_header',
		'type'            => 'select',
		'priority'        => 100,
		'choices'         => array(
			'store-info' 	=> esc_html__( 'Store Information', 'ecommerce-gem-plus' ),
			'current-date' 	=> esc_html__( 'Current Date', 'ecommerce-gem-plus' ),
			'menu' 			=> esc_html__( 'Menu', 'ecommerce-gem-plus' ),
			'social-icons'  => esc_html__( 'Social Icons', 'ecommerce-gem-plus' ),
		),
		'active_callback' => 'ecommerce_gem_is_top_header_active',
	)
);
...
$wp_customize->add_control( 'theme_options[top_address]',
	array(
		'label'    			=> esc_html__( 'Address/Location', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'text',
		'priority' 			=> 100,
...
$wp_customize->add_control( 'theme_options[top_phone]',
	array(
		'label'    			=> esc_html__( 'Phone Number', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'text',
		'priority' 			=> 100,
		'active_callback' 	=> 'ecommerce_gem_is_top_header_information_active',
...
$wp_customize->add_control( 'theme_options[top_email]',
	array(
		'label'    			=> esc_html__( 'Email', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'text',
		'priority' 			=> 100,
		'active_callback' 	=> 'ecommerce_gem_is_top_header_information_active',
...
$wp_customize->add_control( 
	new eCommerce_Gem_Info( 
		...
		array(
			'label' 			=> esc_html__( 'Right Section', 'ecommerce-gem-plus' ),
			'section' 			=> 'section_header',
			'priority' 			=> 100,
			'active_callback' 	=> 'ecommerce_gem_is_top_header_active',
		) 
...
$wp_customize->add_control( 'theme_options[show_social_icons]',
	array(
		'label'    			=> esc_html__( 'Show Social Icons', 'ecommerce-gem-plus' ),
		'description'       => esc_html__( '(Go to Appearance >> Menus, create menu and assign it to Social Links)', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'checkbox',
		'priority' 			=> 100,
		'active_callback' 	=> 'ecommerce_gem_is_top_header_active',
...
$wp_customize->add_control( 'theme_options[show_login_logout]',
	array(
		'label'    			=> esc_html__( 'Show Login/Register', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'checkbox',
		'priority' 			=> 100,
		'active_callback' 	=> 'ecommerce_gem_is_top_header_active',
...
$wp_customize->add_control( 'theme_options[login_icon]',
	array(
		'label'    			=> esc_html__( 'Login/Register Icon', 'ecommerce-gem-plus' ),
		'description'       => esc_html__( 'Fontawesome icons are only supported.', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'text',
		'priority' 			=> 100,
...
$wp_customize->add_control( 'theme_options[login_text]',
	array(
		'label'    			=> esc_html__( 'Login/Register Text', 'ecommerce-gem-plus' ),
		'section'  			=> 'section_header',
		'type'     			=> 'text',
		'priority' 			=> 100,
		'active_callback' 	=> 'ecommerce_gem_is_top_login_logout_active',
...
if ( class_exists( 'WooCommerce' ) ) {
	...
	$wp_customize->add_control( 'theme_options[show_cart]',
		array(
			'label'    			=> esc_html__( 'Show Cart Icon', 'ecommerce-gem-plus' ),
			'section'  			=> 'section_header',
			'type'     			=> 'checkbox',
			'priority' 			=> 100,
			'active_callback' 	=> 'ecommerce_gem_is_top_header_active',
	...
	$wp_customize->add_control( 'theme_options[cart_icon]',
		array(
			'label'    			=> esc_html__( 'Cart Icon', 'ecommerce-gem-plus' ),
			'description'       => esc_html__( 'Fontawesome icons are only supported.', 'ecommerce-gem-plus' ),
			'section'  			=> 'section_header',
			'type'     			=> 'text',
			'priority' 			=> 100,
	...
	$wp_customize->add_control( 'theme_options[show_wishlist]',
		array(
			'label'    			=> esc_html__( 'Show Wishlist Icon (Works if YITH Wishlist plugin is activated)', 'ecommerce-gem-plus' ),
			'section'  			=> 'section_header',
			'type'     			=> 'checkbox',
			'priority' 			=> 100,
			'active_callback' 	=> 'ecommerce_gem_is_top_header_active',
	...
	$wp_customize->add_control( 'theme_options[wishlist_icon]',
		array(
			'label'    			=> esc_html__( 'Wishlist Icon', 'ecommerce-gem-plus' ),
			'description'       => esc_html__( 'Fontawesome icons are only supported.', 'ecommerce-gem-plus' ),
			'section'  			=> 'section_header',
			'type'     			=> 'text',
			'priority' 			=> 100,
	...
	$wp_customize->add_section( 'section_product_search',
		array(
			'title'      => esc_html__( 'Product Search Options', 'ecommerce-gem-plus' ),
			'priority'   => 100,
			'panel'      => 'theme_option_panel',
		)
	);
	...
	$wp_customize->add_control( 'theme_options[show_top_search]',
		array(
			'label'    			=> esc_html__( 'Show Product Search (at Top Header)', 'ecommerce-gem-plus' ),
	...
	$wp_customize->add_control( 'theme_options[search_products_text]',
		array(
			'label'    			=> esc_html__( 'Search Products Text', 'ecommerce-gem-plus' ),
			'section'  			=> 'section_product_search',
			'type'     			=> 'text',
			'priority' 			=> 100,
	...
	$wp_customize->add_control( 'theme_options[select_category_text]',
		array(
			'label'    			=> esc_html__( 'Select Category Text', 'ecommerce-gem-plus' ),
			'section'  			=> 'section_product_search',
			'type'     			=> 'text',
			'priority' 			=> 100,
			'active_callback' 	=> 'ecommerce_gem_is_top_product_search_active',
