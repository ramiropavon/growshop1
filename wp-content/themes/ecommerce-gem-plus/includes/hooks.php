                        ...
                        if (is_user_logged_in()) { ?> 
                            ...
                            <div class="top-account-wrapper logged-in">
                                <a href="<?php echo esc_url(wp_logout_url(home_url())); ?>">
                                    ...
                                    <span class="top-log-out"><?php esc_html_e('Log Out', 'ecommerce-gem-plus'); ?></span>
                                </a>
                            </div>
                            ...
                            <div class="search-box" style="display: none;">
                                ...
                                if ( class_exists( 'WooCommerce' ) ) {
                                    ...
                                    if( !empty( $search_products_text ) ){
                                        ...
                                        $product_search_text =  esc_attr_x( 'Search Products &hellip;', 'placeholder', 'ecommerce-gem-plus' );
                                    }
                                    ...
                                    if( !empty( $select_category_text ) ){
                                        ...
                                        $product_category_text =  esc_html__( 'Select Category', 'ecommerce-gem-plus' );
                                    }
                                 ...
                                 ?>
                                    ...
                                    <div class="product-search-wrapper">
                                        ...
                                        <form role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                            ...
                                            <button type="submit" class="search-submit"><span class="screen-reader-text"><?php echo _x( 'Search', 'submit button', 'ecommerce-gem-plus' ); ?></span><i class="fa fa-search" aria-hidden="true"></i></button>
                                        </form>
...
if ( ! function_exists( 'ecommerce_gem_before_header_action' ) ) :
    ...
    function ecommerce_gem_before_header_action() {
        ...
        ?><div class="sticky-wrapper" id="sticky-wrapper"><header id="masthead" class="site-header  main-navigation-holder" role="banner"><div class="container"><?php
    }
endif;
...
if ( ! function_exists( 'ecommerce_gem_credit_info' ) ) :
    ...
    function ecommerce_gem_credit_info(){ 
        ...
        $powerby_text = ecommerce_gem_get_option( 'powerby_text' );
