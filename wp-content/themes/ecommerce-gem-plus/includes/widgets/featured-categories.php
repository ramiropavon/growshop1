	...
	class eCommerce_Gem_Featured_Categories_Widget extends WP_Widget {
	    ...
	    function __construct() {
	    	$opts = array(
				...
				'description' => esc_html__( 'Widget to display featured categories of Woo-Commerce with carousel', 'ecommerce-gem-plus' ),
    		);

			parent::__construct( 'ecommerce-gem-featured-categories', esc_html__( 'eC-Gem: Featured Categories', 'ecommerce-gem-plus' ), $opts );
	    }
	    ...
	    function form( $instance ) {
	        ...
	        $instance = wp_parse_args( (array) $instance, array(
				'title'          		=> '',
				'product_category'		=> '',
				'view_details'          => esc_html__( 'View Details', 'ecommerce-gem-plus' ),
				'featured_cats' 		=> array(),
				'show_counts'		   	=> 0,
				'disable_carousel'   	=> 0,
            ...
            <p>
				<label for="<?php echo  esc_attr( $this->get_field_id( 'product_category' ) ); ?>"><strong><?php esc_html_e( 'Select Category:', 'ecommerce-gem-plus' ); ?></strong></label>
				...
				<div class="multiple-checkbox-holder">
					...
					if( !empty( $product_categories ) ){
						...
						esc_html_e('No product categories found', 'ecommerce-gem-plus');

					} ?>
				</div>

				<small>
		        	<?php esc_html_e('Categories selected here will be used as featured category at frontend.', 'ecommerce-gem-plus'); ?>	
		        </small>
        	</p>

        	<p>
        		<label for="<?php echo esc_attr( $this->get_field_id( 'view_details' ) ); ?>"><strong><?php esc_html_e( 'View Detail Text:', 'ecommerce-gem-plus' ); ?></strong></label>
	        ...
	        <p>
	            ...
	            <label for="<?php echo $this->get_field_id( 'show_counts' ); ?>"><?php esc_html_e( 'Show Product Counts', 'ecommerce-gem-plus' ); ?></label>
	        </p>
	        ...
	        <p>
	            ...
	            <label for="<?php echo $this->get_field_id( 'disable_carousel' ); ?>"><?php esc_html_e( 'Disable Carousel Mode', 'ecommerce-gem-plus' ); ?></label>
	        </p>
