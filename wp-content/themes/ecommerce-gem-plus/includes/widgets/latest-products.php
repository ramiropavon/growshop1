	...
	class eCommerce_Gem_Latest_Products_Widget extends WP_Widget {
	    ...
	    function __construct() {
	    	$opts = array(
				...
				'description' => esc_html__( 'Widget to display latest product or featured products of Woo-Commerce with carousel', 'ecommerce-gem-plus' ),
    		);

			parent::__construct( 'ecommerce-gem-latest-products', esc_html__( 'eC-Gem: Products Carousel', 'ecommerce-gem-plus' ), $opts );
	    }
	    ...
	    function form( $instance ) {
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id( 'product_type' ) ); ?>"><strong><?php _e( 'Product Type:', 'ecommerce-gem-plus' ); ?></strong></label>
    			<?php
	        ...
	        <p>
	        	<label for="<?php echo esc_attr( $this->get_field_name('product_number') ); ?>">
	        		<?php esc_html_e('Number of Products:', 'ecommerce-gem-plus'); ?>
	        	</label>
        ...
        function dropdown_product_type( $args ) {
    		...
    		$choices = array(
    			'latest' 	=> esc_html__( 'Latest', 'ecommerce-gem-plus' ),
    			'featured' 	=> esc_html__( 'Featured', 'ecommerce-gem-plus' ),
    		);
