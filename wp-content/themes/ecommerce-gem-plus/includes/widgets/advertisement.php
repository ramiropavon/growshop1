	...
	class eCommerce_Gem_Advertisement_Widget extends WP_Widget {
		...
		function __construct() {
			$opts = array(
				...
				'description' => esc_html__( 'Widget to display advertisement. Recommended to use in Advertisement Below Slider area', 'ecommerce-gem-plus' ),
			);
			parent::__construct( 'ecommerce-gem-advertisement', esc_html__( 'eC-Gem: Advertisement', 'ecommerce-gem-plus' ), $opts );
		}
		...
		function form( $instance ) {
			...
			$instance = wp_parse_args( (array) $instance, array(
				'title'       			=> '',
				'sub_title'    			=> '',
				'offer_percent'         => esc_html__( '50%', 'ecommerce-gem-plus' ),
				'offer_text'            => esc_html__( 'OFF', 'ecommerce-gem-plus' ),
				'button_text' 			=> esc_html__( 'Start Shopping', 'ecommerce-gem-plus' ),
				'button_url'  			=> '',
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'sub_title' ) ); ?>"><strong><?php esc_html_e( 'Sub Title:', 'ecommerce-gem-plus' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offer_percent' ) ); ?>"><strong><?php esc_html_e( 'Offer Percent:', 'ecommerce-gem-plus' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offer_text' ) ); ?>"><strong><?php esc_html_e( 'Offer Text:', 'ecommerce-gem-plus' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>"><strong><?php esc_html_e( 'Primary Button Text:', 'ecommerce-gem-plus' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_url' ) ); ?>"><strong><?php esc_html_e( 'Primary Button URL:', 'ecommerce-gem-plus' ); ?></strong></label>
	        ...
	        <p>
	          <label for="<?php echo esc_attr( $this->get_field_id( 'content_position' ) ); ?>"><strong><?php esc_html_e( 'Content Position:', 'ecommerce-gem-plus' ); ?></strong></label>
				<?php
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id( 'content_style' ) ); ?>"><strong><?php esc_html_e( 'Content style:', 'ecommerce-gem-plus' ); ?></strong></label>
    			<?php
			...
			<div class="cover-image">
                <label for="<?php echo esc_attr( $this->get_field_id( 'bg_pic' ) ); ?>">
                    <strong><?php esc_html_e( 'Background Image:', 'ecommerce-gem-plus' ); ?></strong>
                </label>
                ...
                <div class="rtam-preview-wrap" <?php echo $wrap_style; ?>>
                    <img src="<?php echo esc_url( $bg_pic ); ?>" alt="<?php esc_attr_e( 'Preview', 'ecommerce-gem-plus' ); ?>" />
                </div><!-- .rtam-preview-wrap -->
                <input type="button" class="select-img button button-primary" value="<?php esc_html_e( 'Upload', 'ecommerce-gem-plus' ); ?>" data-uploader_title="<?php esc_html_e( 'Select Background Image', 'ecommerce-gem-plus' ); ?>" data-uploader_button_text="<?php esc_html_e( 'Choose Image', 'ecommerce-gem-plus' ); ?>" />
                <input type="button" value="<?php echo esc_attr_x( 'X', 'Remove Button', 'ecommerce-gem-plus' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $delete_button ); ?>" />
            </div>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'disable_overlay' ); ?>"><?php esc_html_e( 'Disable overlay of the image', 'ecommerce-gem-plus' ); ?></label>
            </p>
		<?php
		} 
        ...
        function dropdown_content_style( $args ) {
    		...
    		$choices = array(
    			'style-1' 	=> esc_html__( 'Style One', 'ecommerce-gem-plus' ),
    			'style-2' 	=> esc_html__( 'Style Two', 'ecommerce-gem-plus' ),
    		);
