    ...
    class eCommerce_Gem_Features_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Widget to display features with icon and description including one main image.', 'ecommerce-gem-plus'),
            );
            parent::__construct('ecommerce-gem-features', esc_html__('eC-Gem: Features', 'ecommerce-gem-plus'), $opts);
        }
        ...
        function form($instance) {
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #1', 'ecommerce-gem-plus'); ?></strong></span>
            </h4>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('feature_one')); ?>">
                    <?php esc_html_e('Title:', 'ecommerce-gem-plus'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('text_one')); ?>">
                    <?php esc_html_e('Short Description:', 'ecommerce-gem-plus'); ?>
                </label>
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #2', 'ecommerce-gem-plus'); ?></strong></span>
            </h4>
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #3', 'ecommerce-gem-plus'); ?></strong></span>
            </h4>
