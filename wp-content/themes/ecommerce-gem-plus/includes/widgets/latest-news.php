    ...
    class eCommerce_Gem_Latest_News_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Widget to dispaly latest posts with thumbnail, title, short content and read more link', 'ecommerce-gem-plus'),
            );

            parent::__construct('ecommerce-gem-latest-news', esc_html__('eC-Gem: Latest News', 'ecommerce-gem-plus'), $opts);
        }
        ...
        function form($instance) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_category')); ?>"><strong><?php esc_html_e('Select Category:', 'ecommerce-gem-plus'); ?></strong></label>
                <?php
                $cat_args = array(
                    'orderby' => 'name',
                    'hide_empty' => 0,
                    ...
                    'show_option_all' => esc_html__('All Categories', 'ecommerce-gem-plus'),
                );
                wp_dropdown_categories($cat_args);
                ?>
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('exclude_categories')); ?>"><strong><?php esc_html_e('Exclude Categories:', 'ecommerce-gem-plus'); ?></strong></label>
                ...
                <small>
                    <?php esc_html_e('Enter category id seperated with comma. Posts from these categories will be excluded from latest post listing.', 'ecommerce-gem-plus'); ?>	
                </small>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('excerpt_length')); ?>">
                    <?php esc_html_e('Excerpt Length:', 'ecommerce-gem-plus'); ?>
                </label>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('disable_date'); ?>"><?php esc_html_e('Hide Posted Date', 'ecommerce-gem-plus'); ?></label>
            </p>
            <?php
        }
