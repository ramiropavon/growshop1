	...
	class eCommerce_Gem_CTA_Widget extends WP_Widget {
		...
		function __construct() {
			$opts = array(
				...
				'description' => esc_html__( 'Call To Action Widget', 'ecommerce-gem-plus' ),
			);
			parent::__construct( 'ecommerce-gem-cta', esc_html__( 'eC-Gem: CTA', 'ecommerce-gem-plus' ), $opts );
		}
		...
		function form( $instance ) {
			...
			$instance = wp_parse_args( (array) $instance, array(
				...
				'button_text' 			=> esc_html__( 'Purchase Now', 'ecommerce-gem-plus' ),
				'button_url'  			=> '',
				'bg_pic'      			=> '',
			) );
