...
$slider_type = ecommerce_gem_get_option( 'slider_type' );

if ( 'shortcode' === $slider_type ) {

    $slider_shortcode = ecommerce_gem_get_option( 'slider_shortcode' );

    if( !empty( $slider_shortcode ) ){ ?>

    	<div class="external-slider-wrap">
						...
						<div class="container">
							<div class="caption-wrap">
								<div class="caption-inner">
									...
									<?php 
									if( !empty( $readmore_text ) && !empty( $readmore_link ) ){ ?>
